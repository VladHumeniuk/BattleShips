package humeniuk.battleships.presentation.battle.view.adapter;
...
public class BattleGridAdapter extends BaseGridAdapter {

    public BattleGridAdapter(Context context, Cell[][] cells, CellViewUtil cellViewUtil, CellClickListener listener) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        cellView.setImageResource(getCellViewUtil().getCellBattleBackgroundByState(cell.getCellState()));
